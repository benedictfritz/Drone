package entities 
{
	...
	public class Timing extends Entity
	{
		...
		public function Timing() 
		{
			...
			sineTimings[0] = [58000, 999999999];
			sineTimings[1] = [26000, 46000, 86500, 106500, 141500, 999999999];
			sineTimings[2] = [18200, 38000, 78250, 98500, 135000, 146500, 999999999];
			sineTimings[3] = [66500, 999999999];
			sineTimings[4] = [54000, 64500, 129000, 999999999];
			sineTimings[5] = [0, 24250, 34000, 44000, 75000, 84500, 105000, 129000, 146500, 155400, 999999999];
		}
